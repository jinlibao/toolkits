...
mat1 = uint8(mat);
mat2 = uint8(255-mat);
name1 = strcat(string, '_1.png');
name2 = strcat(string, '_2.png');
loc = '..\Results\';
locname1 = strcat(loc, name1);
locname2 = strcat(loc, name2);
imwrite(mat1, locname1);
imwrite(mat2, locname2);
