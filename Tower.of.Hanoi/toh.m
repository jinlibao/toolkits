...
hf = figure('Color',[0.2745 0.7686 0.9882],...
    'Name','Towers of Hanoi - Applied Mathematics 1101 Jin Libao',...
    'Menu','none');
% Add Title 'Towers of Hanoi' and set the format of it
ht1 = uicontrol(hf,'Style','text',...
    'String','Towers of Hanoi',...
    'FontName','Broadway',...
    'FontWeight','bold',...
    'Units','normalized',...
    'Position',[0.3,0.90,0.4,0.08],...
...
ht2 = uicontrol(hf,'Style','text',...
    'String','Applied Mathematics 1101 Jin Libao',...
    'FontName','Times New Roman',...
    'FontWeight','bold',...
    'Units','normalized',...
    'Position',[0.6,0.85,0.4,0.05],...
    'BackgroundColor',[0.2745 0.7686 0.9882],...
...
hsmin = uicontrol(hf,'Style','text',...
    ...
    'String','Slow',...
    'Units','normalized',...
    'Position',[0.07 0.075 0.05 0.045],...
    'BackgroundColor',[0.2745 0.7686 0.9882]);
hsmax = uicontrol(hf,'Style','text',...
    'Fontname','Gabriola',...
    'String','Fast',...
    'Units','normalized',...
    'Position',[0.21 0.075 0.05 0.045],...
    'BackgroundColor',[0.2745 0.7686 0.9882]);
...
if ss(3) < 1366
    ...
    set(ht4,'FontSize',8);
    set(ht5,'FontSize',14);
    set(hbExit,'FontSize',14);
    set(hsmin,'FontSize',15);
    set(hsmax,'FontSize',15);
    set(hPause,'FontSize',14)
elseif ss(3) >= 1366    
    set(ht1,'FontSize',32);
    set(ht2,'FontSize',20);
    set(ht3,'FontSize',10);
    set(ht4,'FontSize',10);
    set(ht5,'FontSize',20);
    set(hbExit,'FontSize',20);
    set(hsmin,'FontSize',20);
    set(hsmax,'FontSize',20);
    set(hPause,'FontSize',20);  
end
...
tc = num2str(tt);
set(ht5,'String',['You have spent ' tc  'seconds!']);
