...
disp('DIY your own grayscale logo!');
string = input('Please enter a string below\n','s');
n = length(string);
depth = input('Please enter the depth of color respectively which range from 0 to 1\n');
mat = [];
for k = 1:n
    switch(string(k))
        case 'A'
...
mat1 = uint8(mat);
mat2 = uint8(255-mat);
imwrite(mat1,'..\Results\Logo1.png');
imwrite(mat2,'..\Results\Logo2.png');